...
export class DesignSecondPage extends React.Component {
	render() {
		return (
			<div>
				<div className="sc-jWBwVP hwqTUd">
					<div className="sc-brqgnP lldGUU">
						...
						<div className="sc-ifAKCX hRTQN">
							...
							<img src="../images/wage-graphs-530x505.svg" alt="" className="sc-bZQynM BYGmW" />
					...
					<div className="sc-dfVpRl gQEOBy">
						<div className="sc-kTUwUJ kwFiNo">
							<div className="sc-dqBHgY etIerM">© Copyright Wage Compete</div>
...
export default DesignSecondPage;